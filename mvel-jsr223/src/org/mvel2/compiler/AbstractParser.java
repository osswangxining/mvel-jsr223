    ...
    if (op1 instanceof Integer) {
      if (op2 instanceof Integer) {
        ...
        reduce((Integer) op1, operator, (Long) op2);
    	  ...
    	  String s = op2==null?"0":op2.toString();
    	  if(operator == Operator.BW_AND || operator == Operator.BW_OR || operator == Operator.BW_XOR){
    		  if(Boolean.valueOf(s)){
    			  reduce((Integer) op1, operator, new Integer(1));
    		  }else{    			  
    	    	  reduce((Integer) op1, operator, new Integer(0));
    		  }
    		 
    	  }else{
	    	  Double _op2 = new Double(s);
	    	  reduce((Integer) op1, operator, _op2.longValue());
    	  }
      }
    }
    else {
      if (op2 instanceof Integer) {
    	if(op1 instanceof Long){  
    		reduce((Long) op1, operator, (Integer) op2);
    		 ...
    		 String s = op1==null?"0":op1.toString();
    		 if(operator == Operator.BW_AND || operator == Operator.BW_OR || operator == Operator.BW_XOR){
       		  if(Boolean.valueOf(s)){
       			reduce(new Integer(1), operator, (Integer) op2);
       		  }else{    			  
       			reduce(new Integer(0), operator, (Integer) op2);
       		  }
       		 
       	  }else{
    		 Double _op1 = new Double(s);
       	  	reduce(_op1.longValue(), operator, (Integer) op2);
       	  }
    	}
      }
      else {
    	  if(op1 instanceof Long && op2 instanceof Long){
    		  ...
    		  String s = op1==null?"0":op1.toString();
    		 	String s2 = op2==null?"0":op2.toString();
    		  if(operator == Operator.BW_AND || operator == Operator.BW_OR || operator == Operator.BW_XOR){
    			  Integer _op1 = new Integer(0);
    			  Integer _op2 = new Integer(0);
           		  if(Boolean.valueOf(s)){
           			  _op1 = new Integer(1);           			
           		  }
           		 if(Boolean.valueOf(s2)){
          			  _op2 = new Integer(1);           			
          		  }
           		reduce(_op1, operator, _op2);
           		 
           	  }else{
	    		 
	    		  Double _op1 = new Double(s);
	          
	           	Double _op2 = new Double(s2);
	           	  reduce(_op1.longValue(), operator, _op2.longValue());
           	  }
    	  }
      }
    }
